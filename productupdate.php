...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_status)){
        $status_err = "Please enter the new price.";     
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <div class="form-group <?php echo (!empty($status_err)) ? 'has-error' : ''; ?>">
                            <label style="font-size: 20px; text-align: center;">Price</label>
                        ...
                        <a style="width: 140px; margin-left: 70px; background-color: azure;" href="product.php" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
