            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left"> Artists & Designers in the system</h2>
                    </div>
                    <?php
                    ...
                    $sql = "SELECT id, names, profession,image FROM artists";
                    if($result = mysqli_query($db, $sql)){
                        if(mysqli_num_rows($result) > 0){

                            echo "<a href='addartist.php'  class='btn btn-success'>Add New Artist</a>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                             ...
                                             echo "<a href='artistdelete.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
