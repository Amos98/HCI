            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h1>Delete Artist/Designer</h1>
                    </div>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            <input type="hidden" name="id" value="<?php echo trim($_GET["id"]); ?>"/>
                            <p>Are you sure you want to delete this Artist?</p><br>
                            <p>
                                <input style="width: 100px; margin-left: 70px;" type="submit" value="Yes" class="btn btn-danger">
                                <a style="width: 100px; margin-left: 70px;" href="artist.php" class="btn btn-default">No</a>
                            </p>
                        </div>
                    </form>
                </div>
