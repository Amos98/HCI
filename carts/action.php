...
if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){ 
    if($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])){ 
        ...
        $to='sintiyoamos@gmail.com';
        $subject='Client information';
        $message="Reference No: " . $_SESSION['postData']."\n"."First Name: ". $first_name."\n" . "Last Name: ". $last_name."\n" . "Phone No:" . $phone."\n" . "Address: ".  $address."";
        $header="From: ".$email;

        if (mail($to, $subject, $message)) {
            echo "Order sent successfully"." ".$first_name."".$last_name.", thankyou for shopping with us and welcome again";
            # code...
        }
        else{
        ...
        if(empty($errorMsg)){ 
            ...
            $insertCust = $db->query("INSERT INTO customers (first_name, last_name, email, phone, address) VALUES ('".$first_name."', '".$last_name."', '".$email."','".$payment."' '".$phone."', '".$address."')"); 
